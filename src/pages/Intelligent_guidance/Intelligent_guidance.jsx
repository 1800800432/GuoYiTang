...
import {storeInteTreatStep1} from "../../actions/inte-treat";
import {BASEURL} from "../../constants/global";
import './Intelligent_guidance.less'
...
class Intelligent_guidance extends Component{
  constructor () {
    super(...arguments)
    var today = new Date(),
  ...
  /*点击下一步*/
  toIntelligent_guidance_step2(){
    new Promise((resolve,reject) => {
      this.props.storeInteTreatStep1(this.state.sex, this.state.dateSel)
      resolve()
    }).then(()=>{
        Taro.navigateTo({url:'/pages/Intelligent_guidance/Intelligent_guidance_step2'});
    })
  }
  ...
  render(){
    ...
    return(
      <View>
        ...
        <View><AtButton type='primary' className='dia-btn' onClick={this.toIntelligent_guidance_step2.bind(this)}>下一步</AtButton></View>
      </View>
    )
  }
}
export default Intelligent_guidance